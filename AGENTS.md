...
**目标股票**（25 只）：列表由 `stocks_config.STOCKS` 定义，预测时动态读取。包含 21 只原始股 + 4 只 2026-05-13 新增（协创数据/牧原股份/北方稀土/赣锋锂业），已移除 ETF。
...
- **qlib_bin**：唯一覆盖科创板 688xxx 的数据源，25/25 目标股票全覆盖
...
|------|:---:|:---:|---------:|:---:|
| qlib_bin all (6091) | 0.051 | 0.758 | 5,753,171 | 25/25 |
| qlib_bin csi800 (1993) | 0.028 | 0.242 | 1,944,393 | 25/25 |
